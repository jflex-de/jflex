/* The following code was generated by JFlex 1.5.0-SNAPSHOT on 9/9/13 3:55 AM */
 ...
 * on 9/9/13 3:55 AM from the specification file
 * <tt>src/test/cases/dot-newline/dotnewline.flex</tt>
 */
public class Dotnewline {
  ...
  private static final String ZZ_CMAP_PACKED = 
    "\12\0\1\1\1\3\1\3\1\2\167\0\1\3\u1fa2\0\1\3\1\3"+
    "\udfd6\0";
   ...
   */
  public Dotnewline(java.io.Reader in) {
    this.zzReader = in;
  }
   ...
   */
  public Dotnewline(java.io.InputStream in) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        ...
        default: 
          if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
            zzAtEOF = true;
              {
                for (Interval interval : dotIntervals) {
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java Dotnewline [ --encoding <name> ] <inputfile(s)>");
    }
    else {
      int firstFilePos = 0;
      ...
      for (int i = firstFilePos; i < argv.length; i++) {
        Dotnewline scanner = null;
        try {
          java.io.FileInputStream stream = new java.io.FileInputStream(argv[i]);
          java.io.Reader reader = new java.io.InputStreamReader(stream, encodingName);
          scanner = new Dotnewline(reader);

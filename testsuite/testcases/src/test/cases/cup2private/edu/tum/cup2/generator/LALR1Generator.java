	...
	extends LRGenerator<LR1Item, LR1State>
{
	 ...
	 */
	public LALR1Generator(CUP2Specification spec)
	 ...
	 * Computes a {@link LRParsingTable} for the given specification.
	 */
	public LALR1Generator(CUP2Specification spec, Verbosity verbosity)
		throws GeneratorException
	{
	 ...
	 */
	public LALR1Generator(CUP2Specification spec, Verbosity verbosity, boolean extendGrammar)
		throws GeneratorException
	{

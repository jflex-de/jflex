...
/**
 * LR(1) parallel parser generator.
 * 
 ...
 */
public class LR1ParallelGenerator
	extends LRGenerator<LR1Item, LR1State>
{
	 ...
	 */
	public LR1ParallelGenerator(CUP2Specification spec)
	 ...
	 * Computes a {@link LRParsingTable} for the given LR(1) specification.
	 */
	public LR1ParallelGenerator(CUP2Specification spec, Verbosity verbosity)
		throws GeneratorException
	{
	 ...
	 */
	public LR1ParallelGenerator(CUP2Specification spec, Verbosity verbosity, boolean extendGrammar, int numThreads)
		throws GeneratorException
	{
	...
	{
		return new LR1ParallelAutomatonFactory().createAutomaton(this, grammarInfo, numThreads);
	}

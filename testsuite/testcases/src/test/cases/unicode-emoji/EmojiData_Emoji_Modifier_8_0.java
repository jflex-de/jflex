...
// source: src/test/cases/unicode-emoji/EmojiData_Emoji_Modifier_8_0.flex


// See https://github.com/jflex-de/jflex/issues/222
@SuppressWarnings("FallThrough")
public class EmojiData_Emoji_Modifier_8_0 {
   ...
   */
  public EmojiData_Emoji_Modifier_8_0(java.io.Reader in) {
    this.zzReader = in;
  }
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java EmojiData_Emoji_Modifier_8_0 [ --encoding <name> ] <inputfile(s)>");
    }
    else {
      int firstFilePos = 0;
      ...
      for (int i = firstFilePos; i < argv.length; i++) {
        EmojiData_Emoji_Modifier_8_0 scanner = null;
        try {
          java.io.FileInputStream stream = new java.io.FileInputStream(argv[i]);
          java.io.Reader reader = new java.io.InputStreamReader(stream, encodingName);
          scanner = new EmojiData_Emoji_Modifier_8_0(reader);

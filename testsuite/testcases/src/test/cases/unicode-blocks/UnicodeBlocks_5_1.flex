...
\p{Block:Balinese} { charBlock[ (int)yytext().charAt(0) ] = "Balinese"; }
...
\p{Block:Cham} { charBlock[ (int)yytext().charAt(0) ] = "Cham"; }
...
\p{Block:Cyrillic Extended-A} { charBlock[ (int)yytext().charAt(0) ] = "Cyrillic Extended-A"; }
\p{Block:Cyrillic Extended-B} { charBlock[ (int)yytext().charAt(0) ] = "Cyrillic Extended-B"; }
...
\p{Block:Kayah Li} { charBlock[ (int)yytext().charAt(0) ] = "Kayah Li"; }
...
\p{Block:Latin Extended-C} { charBlock[ (int)yytext().charAt(0) ] = "Latin Extended-C"; }
\p{Block:Latin Extended-D} { charBlock[ (int)yytext().charAt(0) ] = "Latin Extended-D"; }
\p{Block:Latin-1 Supplement} { charBlock[ (int)yytext().charAt(0) ] = "Latin-1 Supplement"; }
\p{Block:Lepcha} { charBlock[ (int)yytext().charAt(0) ] = "Lepcha"; }
...
\p{Block:NKo} { charBlock[ (int)yytext().charAt(0) ] = "NKo"; }
...
\p{Block:Ol Chiki} { charBlock[ (int)yytext().charAt(0) ] = "Ol Chiki"; }
...
\p{Block:Phags-pa} { charBlock[ (int)yytext().charAt(0) ] = "Phags-pa"; }
...
\p{Block:Rejang} { charBlock[ (int)yytext().charAt(0) ] = "Rejang"; }
\p{Block:Runic} { charBlock[ (int)yytext().charAt(0) ] = "Runic"; }
\p{Block:Saurashtra} { charBlock[ (int)yytext().charAt(0) ] = "Saurashtra"; }
...
\p{Block:Sundanese} { charBlock[ (int)yytext().charAt(0) ] = "Sundanese"; }
...
\p{Block:Vai} { charBlock[ (int)yytext().charAt(0) ] = "Vai"; }

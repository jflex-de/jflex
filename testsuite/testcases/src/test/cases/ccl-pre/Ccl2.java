 ...
 * <tt>src/test/cases/ccl-pre/ccl2.flex</tt>
 */
public class Ccl2 {
  ...
  private static final String ZZ_CMAP_PACKED = 
    "\11\3\1\0\1\4\3\0\16\3\10\0\1\2\13\0\12\3\6\0"+
    "\1\1\32\2\4\0\1\2\1\0\32\2\4\0\41\3\2\0\4\2"+
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    "\1\2\1\3\1\4\1\2\7\0\1\5\1\4\4\0"+
    "\2\4\1\0";
   ...
   */
  public Ccl2(java.io.InputStream in) {
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java Ccl2 <inputfile>");
    }
    else {
      for (int i = 0; i < argv.length; i++) {
        Ccl2 scanner = null;
        try {
          scanner = new Ccl2( new java.io.FileReader(argv[i]) );
          do {

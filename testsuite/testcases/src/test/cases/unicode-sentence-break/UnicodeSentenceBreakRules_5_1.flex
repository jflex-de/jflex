...
%unicode 5.1
%public
%class UnicodeSentenceBreakRules_5_1
%type String
...
%{
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java UnicodeSentenceBreakRules_5_1 [ --encoding <name> ] <inputfile(s)>");
    }
    else {
      int firstFilePos = 0;
      ...
      UnicodeSentenceBreakRules_5_1 scanner = null;
      for (int i = firstFilePos; i < argv.length; i++) {
        try {
          ...
          while (null != (testLine = bufferedReader.readLine())) {
            ...
            if (null == scanner) {
              scanner = new UnicodeSentenceBreakRules_5_1(testReader);
            } else {
...
// [included SB5. 	X (Extend | Format)* 	→ 	X]
//
[\p{SB:STerm}\p{SB:ATerm}] [\p{SB:Extend}\p{SB:Format}]* (\p{SB:Close} [\p{SB:Extend}\p{SB:Format}]*)* / [\p{SB:Close}\p{SB:Sp}\p{SB:Sep}\p{SB:CR}\p{SB:LF}] { addMatch(); }
...
// [included SB5. 	X (Extend | Format)* 	→ 	X]
//
[\p{SB:STerm}\p{SB:ATerm}] [\p{SB:Extend}\p{SB:Format}]* (\p{SB:Close} [\p{SB:Extend}\p{SB:Format}]*)* (\p{SB:Sp} [\p{SB:Extend}\p{SB:Format}]*)* / [\p{SB:Sp}\p{SB:Sep}\p{SB:CR}\p{SB:LF}] { addMatch(); }
...
// [included SB5. 	X (Extend | Format)* 	→ 	X]
//
[\p{SB:STerm}\p{SB:ATerm}] [\p{SB:Extend}\p{SB:Format}]* (\p{SB:Close} [\p{SB:Extend}\p{SB:Format}]*)* (\p{SB:Sp} [\p{SB:Extend}\p{SB:Format}]*)* ([\p{SB:Sep}\p{SB:CR}\p{SB:LF}] [\p{SB:Extend}\p{SB:Format}]*)? { addMatch(); return nextSegment(); }
[\p{SB:STerm}\p{SB:ATerm}] [\p{SB:Extend}\p{SB:Format}]* (\p{SB:Close} [\p{SB:Extend}\p{SB:Format}]*)* (\p{SB:Sp} [\p{SB:Extend}\p{SB:Format}]*)* ([\p{SB:Sep}\p{SB:CR}\p{SB:LF}] [\p{SB:Extend}\p{SB:Format}]*)? / [^] { addMatch(); return nextSegment(); }

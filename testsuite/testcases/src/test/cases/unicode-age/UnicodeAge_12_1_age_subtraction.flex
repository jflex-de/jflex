...
%unicode 12.1
%public
%class UnicodeAge_12_1_age_subtraction
...
[\p{Age:10.0}--\p{Age:9.0}] { setCurCharPropertyValue("[\\p{Age:10.0}--\\p{Age:9.0}]"); }
[\p{Age:11.0}--\p{Age:10.0}] { setCurCharPropertyValue("[\\p{Age:11.0}--\\p{Age:10.0}]"); }
[\p{Age:12.0}--\p{Age:11.0}] { setCurCharPropertyValue("[\\p{Age:12.0}--\\p{Age:11.0}]"); }
[\p{Age:12.1}--\p{Age:12.0}] { setCurCharPropertyValue("[\\p{Age:12.1}--\\p{Age:12.0}]"); }
[^] { }

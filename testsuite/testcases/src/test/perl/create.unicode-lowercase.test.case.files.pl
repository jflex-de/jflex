#!/usr/bin/perl
#
# create.unicode-lowercase.test.case.files.pl
#
...
my $range_begin = -1;
my $range_category = '';
my $property_value = 'Lowercase';
my $UnicodeData_property_value = 'Ll';
my $DerivedCoreProperties_property_value = 'Lowercase';
my $PropList_property_value = 'Lowercase';
my $property_value_friendly_name = 'Lowercase';
my $property_value_syntax = '[:lowercase:]';

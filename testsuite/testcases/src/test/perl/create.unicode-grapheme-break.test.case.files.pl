#!/usr/bin/perl
#
# create.unicode-grapheme-break.test.output.pl
#
# This script is designed to take as input GraphemeBreakProperty.txt, and
# output hex char ranges and corresponding properties, for all Unicode
# code points (which excludes the surrogates), in the format expected
# as output by the # tests defined for the unicode-grapheme-break
# test case in the JFlex test suite; an example line follows:
#
#   0000..0008; CM
#
...
my $property_name = 'GraphemeClusterBreak';

#!/usr/bin/perl
#
# create.unicode-sentence-break.test.output.pl
#
# This script is designed to take as input SentenceBreakProperty.txt, and
# output hex char ranges and corresponding properties, for all Unicode
# code points (which excludes surrogates), in the format expected as output
# by the # tests defined for the unicode-word-break test case in the JFlex 
...
my $property_name = 'SentenceBreak';

...
maven_jar(
    name = "org_codehaus_plexus_plexus_container_default_1_7_1",
    artifact = "org.codehaus.plexus:plexus-container-default:jar:1.7.1",
)

maven_jar(
    name="org_codehaus_plexus_plexus_classworlds_2_5_2",
    artifact = "org.codehaus.plexus:plexus-classworlds:jar:2.5.2"
)

maven_jar(
    name="org_codehaus_plexus_plexus_utils_3_1_0",
    artifact = "org.codehaus.plexus:plexus-utils:jar:3.1.0"
)

maven_jar(
    name = "org_eclipse_aether_aether_api_1_1_0",
    artifact = "org.eclipse.aether:aether-api:jar:1.1.0",
)

maven_jar(
    name = "org_eclipse_aether_aether_impl_1_1_0",

...
public class TestedVersions {
  ...
  public static final UcdVersion UCD_VERSION_3_0 = newUcdVersion("3.0.1", "ucd_3_0_1").build();
  public static final UcdVersion UCD_VERSION_3_1 = newUcdVersion("3.1.1", "ucd_3_1_1").build();

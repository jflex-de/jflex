...
[ -x lib/ant-1.7.0.jar ] || curl -L $REPO/org/apache/ant/ant/1.7.0/ant-1.7.0.jar -P lib
[ -x lib/auto-value-1.4.1.jar ] || curl -L $REPO/com/google/auto/value/auto-value/1.4.1/auto-value-1.4.1.jar -P lib
set -x

...
public class FileUtilsTest {
  ...
  public void test_getRelativePath_fileInDir() {
    ...
    assertThat(getRelativePath(dir, f).replace("\\", "/")).isEqualTo("d/foo.bar");
  }
  ...
  public void test_getRelativePath_fileNotInDir() {
    ...
    assertThat(getRelativePath(dir, f).replace("\\", "/")).isEqualTo("/d/e/f/foo.bar");
  }
  ...
  public void test_getRelativePath_sameStart() {
    ...
    assertThat(getRelativePath(dir, f).replace("\\", "/")).isEqualTo("/a/b/c.txt");
  }

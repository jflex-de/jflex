...
public class UnicodeProperties {
  ...
  private void init(String version) throws UnsupportedUnicodeVersionException {
    ...
    if (version.equals("1.1") || version.equals("1.1.5")) {
      ...
      bind(Unicode_9_0.propertyValues, Unicode_9_0.intervals, Unicode_9_0.propertyValueAliases,
         Unicode_9_0.maximumCodePoint, Unicode_9_0.caselessMatchPartitions, Unicode_9_0.caselessMatchPartitionSize);
    } else {

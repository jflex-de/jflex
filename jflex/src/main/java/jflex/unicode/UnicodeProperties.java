 ...
 * on data files downloaded from unicode.org on 2009-10-10.
 */
  ...
  public class UnsupportedUnicodeVersionException extends Exception {
    ...
    public UnsupportedUnicodeVersionException() {
      super("Supported versions: " +
              ...
              "1.1, 1.1.5, 2, 2.0, 2.0.14, 2.1, 2.1.9, 3, 3.0, 3.0.1, 3.1, 3.1.0, 3.2, 3.2.0, 4, 4.0, 4.0.1, 4.1, 4.1.0, 5, 5.0, 5.0.0, 5.1, 5.1.0, 5.2, 5.2.0"
      );
    }
  }
}

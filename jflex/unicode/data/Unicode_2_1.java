...
public class Unicode_2_1 {
  ...
  /** Constant <code>propertyValues="{age=1.1, age=2.0, age=2.1, age=unassig"{trunked}</code> */
  public static final String[] propertyValues = {
    ...
    "bidi=eurnumseparator", "bidi=eurnumterminator", "bidi=europeandigit", "bidi=lefttoright",
        "bidi=otherneutral",
    "bidi=righttoleft", "bidi=segmentseparator", "bidi=whitespace", "bidicontrol", "blank",
    "block=alphabeticpresentationforms", "block=arabic", "block=arabicpresentationformsa",
        "block=arabicpresentationformsb", "block=armenian",
    "block=arrows", "block=basiclatin", "block=bengali", "block=blockelements", "block=bopomofo",
    "block=boxdrawing", "block=cjkcompatibility", "block=cjkcompatibilityforms",
        "block=cjkcompatibilityideographs", "block=cjksymbolsandpunctuation",
    "block=cjkunifiedideographs", "block=combiningdiacriticalmarks", "block=combininghalfmarks",
        "block=combiningmarksforsymbols", "block=controlpictures",
    "block=currencysymbols", "block=cyrillic", "block=devanagari", "block=dingbats",
        "block=enclosedalphanumerics",
    "block=enclosedcjklettersandmonths", "block=generalpunctuation", "block=geometricshapes",
        "block=georgian", "block=greek",
    "block=greekextended", "block=gujarati", "block=gurmukhi", "block=halfwidthandfullwidthforms",
        "block=hangulcompatibilityjamo",
    "block=hanguljamo", "block=hangulsyllables", "block=hebrew", "block=hiragana",
        "block=ipaextensions",
    ...
    "block=latinextendeda", "block=latinextendedadditional", "block=latinextendedb",
        "block=letterlikesymbols", "block=malayalam",
    "block=mathematicaloperators", "block=miscellaneoussymbols", "block=miscellaneoustechnical",
        "block=noblock", "block=numberforms",
    "block=opticalcharacterrecognition", "block=oriya", "block=privateuse",
        "block=smallformvariants", "block=spacingmodifierletters",
    "block=specials", "block=superscriptsandsubscripts", "block=tamil", "block=telugu",
        "block=thai",
  ...
  /** Constant <code>intervals="{// Unicode 2.1 property value: {age=1."{trunked}</code> */

 ...
 *
 * <p>Also contains two symbol tables, one for input variables, one for function names.
 *
 * <p>All operations like context check, symbol table build up etc. start here.
 */

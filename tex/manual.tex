...
Version \ver, {\today} \\
\bigskip
\htmladdnormallink{Gerwin Klein}{http://www.doclsf.de}\\
\end{center}
...
assumes, that you are familiar with the issue of lexical analysis. \cite{Appel},
\cite{Aho} and \cite{Maurer} provide a good introduction to this topic.
...
while \htmlref{\emph{Encodings, Platforms, and Unicode}}{sec:encodings} (section \ref{sec:encodings})
provides information about scannig text vs.~binary files.
If you are interested in performance
considerations and comparing JLex vs.~JFlex speed, 
...
These options regard the name, the constructor and related parts of the
...
and functions in the generated scanner. As all options, both \verb+%{+
...
Replaces the \texttt{\%include} verbatim with the specified file. This

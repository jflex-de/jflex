...
\item \verb+--legacydot+\\
  dot (\texttt{.}) metacharacter matches \verb+[^\n]+ instead of
  \verb+[^\n\r\u000B\u000C\u0085\u2028\u2029]+.
...
\item \verb+--table+\\
  ...
  {\bf Deprecated - will be removed in JFlex 1.6}
...
\item 
  ...
  will be removed in JFlex 1.6.} With \texttt{\%switch} JFlex will
...
\item
  ...
  will be removed in JFlex 1.6.} The \texttt{\%table} direction causes

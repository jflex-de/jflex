/* The following code was generated by JFlex 1.4_6 on 4/11/04 12:11 AM */
...
public final class LexScan implements sym, java_cup.runtime.Scanner {
   ...
   */
  private static final String YY_CMAP_PACKED = 
   ...
   * Translates characters to character classes
   */
  private static final char [] YY_CMAP = yyFlexUnpackCMap(YY_CMAP_PACKED);

  /** 
   * Translates DFA states to action switch labels.
   */
  private static final int [] YY_ACTION = yyFlexUnpackAction();

  private static final String YY_ACTION_PACKED_0 =
    ...
    "\2\171\1\0\5\11\2\161\2\164\2\0\1\172\2\0"+
    "\1\37\2\0\2\37\4\0\1\37\2\0\2\37\7\0"+
    "\2\173\1\11\1\156\1\0\1\170\1\171\1\174\1\171"+
    "\1\175\1\11\1\176\1\177\2\200\1\161\4\0\1\201"+
    "\1\0\4\37\3\0\4\37\3\0\2\202\1\0\1\173"+
    "\1\203\1\173\1\204\2\174\1\175\2\205\1\200\1\206"+
    "\1\200\7\0\3\37\5\0\3\37\1\0\2\207\1\0"+
    "\2\203\1\174\1\0\1\205\1\210\1\205\2\206\1\211"+
    "\1\212\4\0\1\37\3\0\1\37\2\213\1\203\1\0"+
    "\2\210\1\206\4\0\1\37\2\0\1\37\1\210\4\0"+
    "\1\214";

  private static int [] yyFlexUnpackAction() {
    int [] result = new int[744];
    int offset = 0;
    offset = yyFlexUnpackAction(YY_ACTION_PACKED_0, offset, result);
    return result;
  }

  private static int yyFlexUnpackAction(String packed, int offset, int [] result) {
   ...
   */
  private static final int [] YY_ROWMAP = yyFlexUnpackRowMap();

  private static final String YY_ROWMAP_PACKED_0 =
    ...
    "\0\u780a\0\u1180\0\u7850\0\u7896\0\u1180\0\u78dc\0\u7922\0\u7968"+
    "\0\u79ae\0\u79f4\0\u7a3a\0\u1180\0\u7a80\0\u1180\0\u7ac6\0\u7b0c"+
    "\0\u7b52\0\u7b98\0\u7bde\0\u7c24\0\u7c6a\0\u7cb0\0\u041a\0\u041a"+
    "\0\u7cf6\0\u7d3c\0\u7d82\0\u7dc8\0\u7e0e\0\u7e54\0\u7e9a\0\u7ee0"+
    "\0\u7f26\0\u7f6c\0\u7fb2\0\u7ff8\0\u803e\0\u8084\0\u80ca\0\u74c2"+
    "\0\u041a\0\u8110\0\u8156\0\u819c\0\u81e2\0\u8228\0\u826e\0\u82b4"+
    "\0\u82fa\0\u8340\0\u8386\0\u83cc\0\u8412\0\u8458\0\u849e\0\u84e4"+
    "\0\u852a\0\u8570\0\u85b6\0\u85fc\0\u8642\0\u8688\0\u041a\0\u86ce"+
    "\0\u8714\0\u875a\0\u87a0\0\u87e6\0\u882c\0\u8872\0\u88b8\0\u88fe"+
    "\0\u8944\0\u898a\0\u89d0\0\u8a16\0\u8a5c\0\u8aa2\0\u8ae8\0\u8b2e"+
    "\0\u8b74\0\u8bba\0\u8c00\0\u8c46\0\u8c8c\0\u8cd2\0\u8d18\0\u8d5e"+
    "\0\u8da4\0\u8dea\0\u8e30\0\u8e76\0\u8ebc\0\u8f02\0\u8f48\0\u8f8e"+
    "\0\u8fd4\0\u1180\0\u1180\0\u901a\0\u9060\0\u90a6\0\u90ec\0\u9132"+
    "\0\u9178\0\u91be\0\u041a\0\u9204\0\u924a\0\u9290\0\u92d6\0\u931c"+
    "\0\u9362\0\u93a8\0\u93ee\0\u9434\0\u947a\0\u94c0\0\u9506\0\u954c"+
    "\0\u9592\0\u95d8\0\u8c8c\0\u041a\0\u961e\0\u9664\0\u96aa\0\u96f0"+
    "\0\u9736\0\u977c\0\u97c2\0\u9808\0\u984e\0\u9894\0\u98da\0\u9920"+
    "\0\u9966\0\u99ac\0\u99f2\0\u9a38\0\u9a7e\0\u9ac4\0\u9b0a\0\u9b50"+
    "\0\u9b96\0\u9bdc\0\u9c22\0\u9c68\0\u9cae\0\u9cf4\0\u9d3a\0\u9d80"+
    "\0\u9dc6\0\u9e0c\0\u9e52\0\u9e98\0\u95d8\0\u041a\0\u9ede\0\u9f24"+
    "\0\u9f6a\0\u9fb0\0\u9ff6\0\ua03c\0\ua082\0\ua0c8\0\ua10e\0\ua154"+
    "\0\u041a\0\u041a\0\ua19a\0\ua1e0\0\ua226\0\ua26c\0\ua2b2\0\ua2f8"+
    "\0\ua33e\0\ua384\0\ua3ca\0\u9ede\0\u041a\0\ua410\0\ua456\0\ua49c"+
    "\0\ua4e2\0\ua528\0\ua56e\0\ua5b4\0\ua5fa\0\ua640\0\ua686\0\ua6cc"+
    "\0\ua712\0\ua758\0\ua79e\0\ua7e4\0\ua82a\0\ua870\0\ua8b6\0\u041a";

  private static int [] yyFlexUnpackRowMap() {
    int [] result = new int[744];
    int offset = 0;
    offset = yyFlexUnpackRowMap(YY_ROWMAP_PACKED_0, offset, result);
    return result;
  }

  private static int yyFlexUnpackRowMap(String packed, int offset, int [] result) {
    int i = 0;  /* index in packed string  */
    int j = offset;  /* index in unpacked array */
    int l = packed.length();
    while (i < l) {
   ...
   */
  private static final int [] YY_TRANS = yyFlexUnpackTrans();

  private static final String YY_TRANS_PACKED_0 =
  ...
  private static int [] yyFlexUnpackTrans() {
    int [] result = new int[43260];
    int offset = 0;
    offset = yyFlexUnpackTrans(YY_TRANS_PACKED_0, offset, result);
    return result;
  }

  private static int yyFlexUnpackTrans(String packed, int offset, int [] result) {
    int i = 0;       /* index in packed string  */
    int j = offset;  /* index in unpacked array */
    int l = packed.length();
    while (i < l) {
   ...
   */
  private static final int [] YY_ATTRIBUTE = yyFlexUnpackAttribute();

  private static final String YY_ATTRIBUTE_PACKED_0 =
    ...
    "\1\11\1\0\10\1\1\0\11\1\2\0\1\11\2\0"+
    "\1\1\2\0\2\1\4\0\1\1\2\0\2\1\7\0"+
    "\4\1\1\0\13\1\4\0\1\11\1\0\4\1\3\0"+
    "\4\1\3\0\1\1\1\11\1\0\14\1\7\0\3\1"+
    "\5\0\3\1\1\0\1\1\1\11\1\0\3\1\1\0"+
    "\5\1\2\11\4\0\1\1\3\0\2\1\1\11\1\1"+
    "\1\0\3\1\4\0\1\1\2\0\2\1\4\0\1\11";

  private static int [] yyFlexUnpackAttribute() {
    int [] result = new int[744];
    int offset = 0;
    offset = yyFlexUnpackAttribute(YY_ATTRIBUTE_PACKED_0, offset, result);
    return result;
  }

  private static int yyFlexUnpackAttribute(String packed, int offset, int [] result) {
    int i = 0;       /* index in packed string  */
    int j = offset;  /* index in unpacked array */
    int l = packed.length();
    while (i < l) {
   ...
   */
  private static char [] yyFlexUnpackCMap(String packed) {
   ...
   */
  private void yyFlexScanError(int errorCode) {
    String message;
    try {
   ...
   */
  private void yyFlexDoEOF() throws java.io.IOException {
    if (!yyFlexEOFDone) {
      yyFlexEOFDone = true;
      yyclose();
    }
  ...
  public Symbol next_token() throws java.io.IOException {
    ...
    int [] yyFlexTransL = YY_TRANS;
    int [] yyFlexRowMapL = YY_ROWMAP;
    int [] yyFlexAttrL = YY_ATTRIBUTE;
    int yyFlexPushbackPos_l = yyFlexPushbackPos = -1;
    ...
    while (true) {
      ...
      boolean yyFlexR = false;
      for (yyFlexCurrentPosL = yyFlexStartRead; yyFlexCurrentPosL < yyFlexMarkedPosL;
                                                             yyFlexCurrentPosL++) {
        switch (yyFlexBufferL[yyFlexCurrentPosL]) {
        case '\u000B':
        case '\u000C':
        case '\u0085':
        case '\u2028':
      ...
      if (yyFlexR) {
        ...
        boolean yyFlexPeek;
        if (yyFlexMarkedPosL < yyFlexEndReadL)
          yyFlexPeek = yyFlexBufferL[yyFlexMarkedPosL] == '\n';
        else if (yyFlexAtEOF)
          yyFlexPeek = false;
        else {
          boolean eof = yyFlexRefill();
          yyFlexMarkedPosL = yyFlexMarkedPos;
          yyFlexBufferL = yyFlexBuffer;
          if (eof) 
            yyFlexPeek = false;
          else 
            yyFlexPeek = yyFlexBufferL[yyFlexMarkedPosL] == '\n';
        }
        if (yyFlexPeek) yyline--;
      }
      if (yyFlexMarkedPosL > yyFlexStartRead) {
        switch (yyFlexBufferL[yyFlexMarkedPosL-1]) {
        case '\n':
        case '\u000B':
        case '\u000C':
        case '\u0085':
        ...
        case '\r': 
          if (yyFlexMarkedPosL < yyFlexEndReadL)
            yyFlexAtBOL = yyFlexBufferL[yyFlexMarkedPosL] != '\n';
          else if (yyFlexAtEOF)
            yyFlexAtBOL = false;
          else {
            boolean eof = yyFlexRefill();
      ...
      if (yyFlexAtBOL)
        yyFlexState = YY_LEXSTATE[yyFlexLexicalState+1];
      else
        yyFlexState = YY_LEXSTATE[yyFlexLexicalState];
      ...
      yy_forAction: {
        while (true) {
          ...
          if (yyFlexCurrentPosL < yyFlexEndReadL)
            yyFlexInput = yyFlexBufferL[yyFlexCurrentPosL++];
          else if (yyFlexAtEOF) {
            yyFlexInput = YYEOF;
            break yy_forAction;
          }
            ...
            yyFlexCurrentPos  = yyFlexCurrentPosL;
            yyFlexMarkedPos   = yyFlexMarkedPosL;
            yyFlexPushbackPos = yyFlexPushbackPos_l;
            boolean eof = yyFlexRefill();
            // get translated positions and possibly new buffer
            yyFlexCurrentPosL  = yyFlexCurrentPos;
            yyFlexMarkedPosL   = yyFlexMarkedPos;
            yyFlexBufferL      = yyFlexBuffer;
            yyFlexEndReadL     = yyFlexEndRead;
            yyFlexPushbackPos_l = yyFlexPushbackPos;
            if (eof) {
              yyFlexInput = YYEOF;
              break yy_forAction;
            }
          ...
          int yyFlexNext = yyFlexTransL[ yyFlexRowMapL[yyFlexState] + yyCMapL[yyFlexInput] ];
          if (yyFlexNext == -1) break yy_forAction;
          yyFlexState = yyFlexNext;

          int yyFlexAttributes = yyFlexAttrL[yyFlexState];
          if ( (yyFlexAttributes & 2) == 2 )
            yyFlexPushbackPos_l = yyFlexCurrentPosL;

          if ( (yyFlexAttributes & 1) == 1 ) {
            yy_was_pushback = (yyFlexAttributes & 4) == 4;
            yyFlexAction = yyFlexState;
            yyFlexMarkedPosL = yyFlexCurrentPosL;
            if ( (yyFlexAttributes & 8) == 8 ) break yy_forAction;
          }
      ...
      yyFlexMarkedPos = yyFlexMarkedPosL;
      if (yy_was_pushback)
        yyFlexMarkedPos = yyFlexPushbackPos_l;

      switch (yyFlexAction < 0 ? yyFlexAction : YY_ACTION[yyFlexAction]) {
        case 85: 
          { return symbol(FULL);
          }
        case 141: break;
    ...
    if (argv.length == 0) {
      ...
      for (int i = 0; i < argv.length; i++) {
        ...
        try {
          ...
          while ( !scanner.yyFlexAtEOF ) scanner.debug_next_token();
        }
